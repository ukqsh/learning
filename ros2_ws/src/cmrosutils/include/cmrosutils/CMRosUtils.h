...
{
    rclcpp::Publisher    Pub;     /*!< Publisher handle */
...
{
    rclcpp::Subscription  Sub;    /*!< Subscriber handle */
...
struct tRosIF_Srv
{
    rclcpp::ServiceServer Srv;   /*!< Service handle for Service Server */
    rclcpp::ServiceClient Clnt;  /*!< Service handle for Service Client */
...
typedef struct tRosIF_Cfg {
    rclcpp::Node Node;  /*!< Node Handle for current process */
} tRosIF_Cfg;
