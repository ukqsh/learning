...
namespace hellocm
{
    ...
    const std::string tpc_in_name2      =  node_name + "/command";            /*!< Default name of Topic from this ROS Node */
    /*ROSBAG topics for testing
    const std::string tpc_in_name3      =   "/control_comand";*/            /*!< Default name of Topic from this ROS Node */
